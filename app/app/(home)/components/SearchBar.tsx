  ...
  return (
    <div className="h-[5rem] py-[1rem] pl-[0.8rem] md:h-[4rem] w-full md:pl-[1rem] md:pr-[1rem] md:pt-[1rem] md:pb-[1rem]">
      <div className="h-full w-full flex relative">
        ...
        <div className={`${hideOnMobile ? 'hidden md:flex' : 'flex'} w-full items-center relative`}>
          <Search className="absolute md:top-1 top-3 md:left-2 left-3 text-gray-600 w-6 h-6" />
