...
export default function DisplayModal({
  ...
  const checkIfAnyFieldChanged = () => {
    if (
      ...
      // id non va toccato
      const item: Item = {id: id, tag: tag, website: website, username: username, password: password, securityLevel: "medium", folderID: "0"}
      updateItem(item);
        ...
        <form className="flex flex-col gap-4 min-w-[280px]" onSubmit={(e) => e.preventDefault()}>
          ...
          <label className="relative" onDoubleClick={() => setIsEditing(true)}>
            ...
            <input
              ...
              placeholder="Tag"
            />
            <button type="button" className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-900" onClick={() => copyToClipboard(tag, 'tag')}>
